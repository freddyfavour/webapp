    ...
    <DashboardLayout>
      <div className="min-h-screen">
        ...
        <div className="flex flex-col">
          {/* Header */}
          <div className="border-b flex mt-3 md:mt-3 items-center justify-between">
                ...
                <Card key={`${booking.id}-${index}`} className="border border-primary py-2 rounded-md overflow-hidden">
                  <CardContent className="">
                    ...
                    <div className="flex px-4 py-2 w-full gap-2">
                      {booking.status === "upcoming" && (
                        <>
                          <Button
                            variant="outline"
                            size="sm"
                            className="flex-1 p-2 text-primary border border-primary rounded-full"
                          ...
                          <Button
                            size="sm"
                            className="flex-1 p-2 bg-primary hover:bg-primary/40 text-white rounded-full"
                          >
                            View receipt
                          </Button>
                        </>
                      ...
                      {booking.status === "completed" && (
                        <Button size="sm" className="w-full p-2 bg-primary hover:bg-primary/60 text-white rounded-full">
                          View receipt
                        </Button>
                      )}
                    </div>
            ...
            <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 relative">
              ...
              <div className="text-center">
                  ...
                  <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="text-left">
                        <p className="font-semibold text-sm">{selectedBooking.salon}</p>
                        <p className="text-sm text-primary">{selectedBooking.service}</p>
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Are you sure you want to cancel this booking? This action cannot be undone and a refund will be
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 relative">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  You have successfully cancelled your booking and we`ll process the refund to your wallet soon.
                </p>

                <Button onClick={handleCloseSuccessModal} className="w-full p-2 rounded-full bg-primary hover:bg-primary/90 text-white">
                  Got it
                </Button>
              </div>
            </div>
