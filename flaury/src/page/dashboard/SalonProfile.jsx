      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-between w-4/5 mx-auto my-4 text-black font-bold">
          <div
            ...
            className={`cursor-pointer text-sm ${tab === "overview" && "text-primaryColor underline"
              }`}
          >
            Overview
          </div>
          <div
            ...
            className={`cursor-pointer text-sm ${tab === "service" && "text-primaryColor underline"
              }`}
          >
            Service
          </div>
          <div
            ...
            className={`cursor-pointer text-sm ${tab === "gallery" && "text-primaryColor underline"
              }`}
          >
            Gallery
          </div>
          <div
            ...
            className={`cursor-pointer text-sm ${tab === "reviews" && "text-primaryColor underline"
              } `}
          >
            Reviews
          </div>
