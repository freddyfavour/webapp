...
const Nav = () => {
  ...
  return (
    <>
      {authNav ? (
        <div className="w-full bg-[#fff] flex justify-center items-center z-[100] border border-b">
          <Link to="/">
        ...
        <>
          <div className=" w-full bg-[#fff] px-4 md:px-20 py-2 z-[100] border border-b">
